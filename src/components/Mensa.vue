<template>
  <v-container>
    <v-layout row wrap v-if="mensa || cafeteria">
      <v-flex md6 xs12 v-for="[type, menu] in Object.entries({mensa, cafeteria})">
        <v-card class="ma-2">
                ...
                <v-flex xs8>
                  <v-card-title primary-title>
                    <div>
                      ...
                      <div v-if="essen.pr">
                        Preis:
                        <span v-for="preis in preise(essen.pr)" v-if="preis">{{preis}}€ </span>
                      </div>
                    </div>
                  </v-card-title>
                </v-flex>
      ...
      "essen": [
        {
          ...
          "vegetarisch": "true",
          "alkohol": "false",
          "deutsch": "Blumenkohl-Käse-Medaillon (15,19,21,81) oder Putenschnitzel mit Zitronenecke (54,81), Sättigungs- und Gemüsebeilagen nach Angebot und Wahl"
        },
        {
          "id": "7282",
          ...
          "vegetarisch": "false",
          "alkohol": "false",
          "deutsch": "Nudelvariation (81), zur Auswahl: vegan: Tomaten-Kräuter-Soße (81), Schinken-Erbsen-Soße (2,19,51,81), geriebener Gouda (1,19) oder Cheddar (19)",
          "pr": [
            {
              "gruppe": "S",
              "$t": "1.90"
        ...
        },
        {
          ...
          "vegetarisch": "false",
          "alkohol": "false",
          "deutsch": "Putenschnitzel mit Zitronenecke (54,81), Kräutermayo-Dip (9,15,19), Buttermöhren (19), Pommes frites",
          "pr": [
            {
              "gruppe": "S",
              "$t": "2.20"
        ...
        },
        {
          ...
          "vegetarisch": "false",
          "alkohol": "true",
          "deutsch": "Yakisoba mit Hähnchen, Spitzkohl, Sojasprossen, Karotten und Porree (1,2,4,18,26,44,49,54,81)",
          "pr": [
            {
              "gruppe": "S",
              "$t": "1.50"
      ...
      "essen": [
        {
          ...
          "vegetarisch": "true",
          "alkohol": "true",
          "deutsch": "Wildlachs mit Spinat und Käse gratiniert an Weißwein-Dill-Soße (1, 16, 19, 24, 44, 81)",
          "pr": {
            "gruppe": "Preis",
            "$t": "4.60"
          }
        },
        {
          ...
          "vegetarisch": "false",
          "alkohol": "false",
          "deutsch": "Kaiserschmarrn hausgemacht aus der Gußpfanne mit Puderzucker und Apfelmusdip (3, 15, 19, 81)",
          "pr": {
            "gruppe": "Preis",
            "$t": "4.20"
          }
        },
        {
          ...
          "vegetarisch": "false",
          "alkohol": "false",
          "deutsch": "Schweinesteak \"Balkan Art\" mit Paprika, Zwiebeln und Wurststreifen dazu Tomatenjus (2, 3, 8, 21, 22, 51, 81)",
          "pr": {
            "gruppe": "Preis",
            "$t": "4.20"
          }
        ...
        },
        {
          ...
          "vegetarisch": "false",
          "alkohol": "false",
          "deutsch": "Putenschnitzel mit Zitronenecke (54,81), Kräutermayo-Dip (9,15,19) dazu Beilagenwahl",
          "pr": [
            {
              "gruppe": "S",
              "$t": "2.40"
